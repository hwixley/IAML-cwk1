...
\large{\textbf{Data properties of the 'regression\_part1.csv' dataset:}}\\
\\
\normalsize{\textbf{\underline{Revision time}}\\
\textbf{Data size:} 8 byte numbers needed for Double precision\\
\textbf{Possible data range:} $0 \leq \mathbf{x\textsubscript{i}}$\\
\textbf{Actual data range:} $2.723 \leq \mathbf{x\textsubscript{i}} \leq 48.011$\\
\textbf{Data type:} Double \emph{(represented in hours)}\\
\\
\textbf{\underline{Exam score}}\\
\textbf{Data size:} 8 byte numbers needed for Double precision\\
\textbf{Possible data range:} $0 \leq \mathbf{y\textsubscript{i}} \leq 100$\\
\textbf{Actual data range:} $14.731 \leq \mathbf{y\textsubscript{i}} \leq 94.945$\\
\textbf{Data type:} Double \emph{(represented in \%)}}
\end{answerbox}
