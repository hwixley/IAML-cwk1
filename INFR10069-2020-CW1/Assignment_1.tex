...
\\
\normalsize{
\textbf{Linear model ($w$):}\\
Coefficient = 1.44114091\\
Intercept = 17.89768025835017\\
\\
\textbf{Regression evaluation metrics:}\\
...
\\
One of the disadvantages of the MSE metric is that it is very sensitive to outliers. This is evident in the equation where the difference in the predicted and actual value of y\textsubscript{i} is squared.
\end{answerbox}
