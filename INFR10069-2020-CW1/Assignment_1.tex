...
\\
\normalsize{
\textbf{Data size:} 50 records\\
\textbf{Data type:} float64\\
\\
\\
\textbf{ATTRIBUTES:}\\
\\
\textbf{\underline{Revision time (represented in hours)}}}\\
\\
...
\\
\\
\normalsize{\textbf{\underline{Exam score (represented in \%)}}}\\
\\
