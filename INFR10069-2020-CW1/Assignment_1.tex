...
\\
Therefore:\\
$\boldsymbol{w} = [17.898, 1.441]$\\
\\
\textbf{\underline{Representation of $\boldsymbol{w}$:}}\\
$\boldsymbol{w_0}$ represents the intercept of the model and thus denotes the minimum estimated possible exam score.\\
...
\\
One of the disadvantages of the MSE metric is that it is very sensitive to outliers. This is evident in the equation as the error value (difference in the predicted and actual value) of y\textsubscript{i} is squared and the average error value is calculated. This squaring ultimately magnifies large errors and minimizes small errors.
\end{answerbox}
...
\begin{answerbox}{20em}
\textbf{\underline{Regression evaluation metrics:}}\\
\\
\textbf{sklearn implementation:}\\
Mean squared error = 30.985472614541305\\
Mean absolute error = 4.246143979155163\\
$R^{2}$ score = 0.9277934754398822\\
\\
\textbf{closed-form implementation:}\\
Mean squared error = 
\end{answerbox}
