...
\fbox{
\parbox{30em}{
\normalsize{\textbf{\underline{Input data properties of the 'faces\_train\_data.csv' dataset:}}}\\
\\
\footnotesize{
...
\\
\\
\normalsize{\textbf{\underline{Input data properties of the 'faces\_test\_data.csv' dataset:}}}\\
\\
\footnotesize{
...
\begin{tabular}{ |c|c|c| }
\hline
\textbf{Class} & \textbf{Training Set Balance} & \textbf{Testing Set Balance} \\ \hline
0 & 51.35\% & 50.67\% \\
1 & 48.65\% & 49.33\% \\
\hline
\end{tabular}
