...
\textbf{Mean:}   $\mathbf{\mu\textsubscript{x}} \approx 22.22$  \\
\textbf{Standard deviation:}   $\mathbf{\sigma\textsubscript{x}} \approx 13.99$}}}\\
\\
\\
\fbox{
\parbox{35em}{
...
\textbf{Mean:}   $\mathbf{\mu\textsubscript{y}} \approx 49.92$  \\
\textbf{Standard deviation:}   $\mathbf{\sigma\textsubscript{y}} \approx 20.93$}}}
\end{answerbox}
...
\fbox{
\parbox{30em}{
\normalsize{\textbf{\underline{Data properties of the "smiling" output attribute:}}}\\
\\
\footnotesize{
...
\large{\textbf{\underline{Top 3 most important attributes according to Gini}}}\\
\large{\textbf{\underline{importance:}}}
\normalsize{
\textbf{
\begin{enumerate}
    \item x50
...
The \textbf{x50} attribute represents one of the points on the top of the face's mouth. Therefore it is not surprising this was given the highest Gini importance as obviously any points on the mouth would be the most significant for recognizing a smile.
}
\end{answerbox}
...
\begin{answerbox}{29em}
\large{\textbf{\underline{AUC evaluations of our models:}}}\\
\\
\\
\normalsize{\textbf{alg\_1 $\approx$ 67.99\%}}\\
\footnotesize{Where TPR $\approx$ 78.71\% \& FPR $\approx$ 42.73\%}\\
\\
\normalsize{\textbf{alg\_2 $\approx$ 59.97\%}}\\
\footnotesize{Where TPR $\approx$ 68.31\% \& FPR $\approx$ 48.37\%}\\
\\
\normalsize{\textbf{alg\_3 $\approx$ 20.11\%}}\\
\footnotesize{Where TPR = 0\% \& FPR $\approx$ 59.77\%}\\
\\
\normalsize{\textbf{alg\_4 $\approx$ 57.96\%}}\\
\footnotesize{Where TPR $\approx$ 100\% \& FPR $\approx$ 84.09\%}\\
\\
\\
\normalsize{
So yes, \textbf{alg\_1} has both the best accuracy and the best AUC throughout all the models.\\
\\
Although alg\_4 has a perfect TPR it has a very poor FPR (almost double that of alg\_1) which greatly brings down it's AUC score, whereas, alg\_1 has the best FPR and the second best TPR.
}
\end{answerbox}
