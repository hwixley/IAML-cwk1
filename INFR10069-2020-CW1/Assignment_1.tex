...
So...\\
\\
$\therefor MSE\textsubscript{sklearn} = MSE\textsubscript{closed-form}   +   1.4210854715202004 * 10^{-14}$\\
\\
This implies our closed-form solution was a tiny bit more accurate than that of the sklearn.
}
\end{answerbox}
