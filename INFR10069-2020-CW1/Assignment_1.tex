...
\textbf{Data properties of the 'regression\_part1.csv' dataset:}\\
\\
\underline{Revision time}\\
Data size: only 8 bit numbers needed\\
Data range: $2.723 \leq \mathbf{x\textsubscript{i}} \leq 48.011$\\
Data type: Double \emph{(represented in hours)}\\
\\
\underline{Exam score}\\
Data size: only 8 bit numbers needed\\
Data range: $0 \leq \mathbf{y\textsubscript{i}} \leq 100$\\
Data type: Double \emph{(represented in \%)}
\end{answerbox}
